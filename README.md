...
See [LICENSE](/workspaces/Presentations/LICENSE) for details.

Third-party code and assets (including the `SyncDeck-Reveal` submodule)
may be licensed separately by their respective owners.
